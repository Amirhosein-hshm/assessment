...
**[Live Demo](https://user-management-demo.vercel.app)** · **Next.js 15** · **React 19** · **Tailwind CSS v4** · **TypeScript**

---

## Features

- **User Listing** — Fetches and displays 10 users from [JSONPlaceholder](https://jsonplaceholder.typicode.com)
